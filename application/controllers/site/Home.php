...
class Home extends ST_Controller {
	...
	public function index(){
		$skillList = $this->get_skill();
		$fraseList = $this->get_frase_list();
		$fraseTempPri = $this->get_tempo_pri();
		$fraseTempAntigo = $this->get_tempo_antigo();
		$fraseTempAntigo = $this->get_tempo_antigo();
		$fraseTempSemana = $this->get_tempo_semana();
		$fraseTempDia = $this->get_tempo_dia();
		$fraseTempMinuto = $this->get_tempo_minuto();
		$fraseTempSegundo = $this->get_tempo_segundo();
		$fraseTempF5 = $this->get_tempo_f5();
	...
	private function get_frase_list(){
		$fraseList = array();
	...
	private function get_tempo_pri(){
		$fraseTempPri = array();
	...
	private function get_tempo_antigo(){
		...
		return $fraseTempAntigo;
	}

	private function get_tempo_semana(){
		...
		return $fraseTempSemana;
	}

	private function get_tempo_dia(){
		$fraseTempDia = array();
	...
	private function get_tempo_minuto(){
		...
		return $fraseTempMinuto;
	}

	private function get_tempo_segundo(){
		...
		return $fraseTempSegundo;
	}

	private function get_tempo_f5(){
		$fraseTempF5 = array();
		$fraseTempF5[] = "ooohhh!";
