<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Conteudo parcelamento</h1>
	</div>
</div>
...
<div class="row">
	<div class="col-lg-6">
		<label>Inflação média ao ano</label>
		<input class="form-control" name='fi_calculo_parcelamento_sac[inflacao_media_ano]' value='7'>
	</div>
	<div class="col-lg-6">
		<label>Valor Financiamento</label>
		<input class="form-control" name='fi_calculo_parcelamento_sac[valor_financiamento]' value='144000'>
	</div>
</div>
</form>
